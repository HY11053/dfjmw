...
@section('headlibs')
    ...
    <meta http-equiv="mobile-agent" content="format=wml; url={{str_replace('http://zhaji.','http://m.zhaji.',config('app.url'))}}" />
    <meta http-equiv="mobile-agent" content="format=xhtml; url={{str_replace('http://zhaji.','http://m.zhaji.',config('app.url'))}}" />
    <meta http-equiv="mobile-agent" content="format=html5; url={{str_replace('http://zhaji.','http://m.zhaji.',config('app.url'))}}" />
    <link rel="alternate" media="only screen and(max-width: 640px)" href="{{str_replace('http://zhaji.','http://m.zhaji.',config('app.url'))}}" >
        ...
        <div class="index_box1 clearfix">
            ...
            <div class="index_box1_r">
                <div class="count">
                    ...
                    <ul>
                        <li><a href="/{{\App\AdminModel\Arctype::where('id',\App\AdminModel\Archive::where('id',29)->value('typeid'))->value('real_path')}}/29.shtml" title="【华莱士炸鸡】低成本、高回报 免费技术培训" target="_blank">【华莱士炸鸡】低成本、高回报 免费技术培训</a></li>
                        <li><a href="/{{\App\AdminModel\Arctype::where('id',\App\AdminModel\Archive::where('id',39)->value('typeid'))->value('real_path')}}/39.shtml" title="【巨咖炸鸡】STAR ZONE 巨咖地带 ☆由你做主" target="_blank">【巨咖炸鸡】STAR ZONE 巨咖地带☆ 由你做主</a></li>
                        <li><a href="/{{\App\AdminModel\Arctype::where('id',\App\AdminModel\Archive::where('id',79)->value('typeid'))->value('real_path')}}/79.shtml" title="【老北京炸鸡】5大口味 独家持有 地道北京味“" target="_blank">【老北京炸鸡】5大口味 独家持有 地道北京味</a></li>
